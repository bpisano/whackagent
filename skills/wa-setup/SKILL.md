...
3. **Review toggles** — surface the public-doc one explicitly, it varies by company: _"Require `///` documentation on every public API? (some teams skip this)"_ → sets `review.public_doc`. Offer to flip the other toggles too.
